  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
      ...
      <div className="flex flex-col sm:gap-4 sm:py-4 sm:pr-14">
        <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6">
          <Sheet>
            ...
            <SheetContent side="right" className="sm:max-w-xs">
              <nav className="grid gap-6 text-lg font-medium place-items-end">
                <Link
                  href="#"
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start">
              ...
              <DropdownMenuItem>ساپورت</DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem
        ...
        <main className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid-cols-2 container">
          {props.children}
        </main>
      </div>
    </div>
